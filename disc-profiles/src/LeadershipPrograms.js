    ...
    render() {
        return (
            <div>
                ...
                <span>Adapting yourself to the needs of your goals might become a challenge. How can you make sure you approach individuals based on their preferences?</span>
                <h1 className="header">Business Communication</h1>
                <img src="./images/CA-4.png" alt="Business Communication" />
                <span>The e-northamerica communication analysis CA® is a model in order to register verbally observable behaviors. The model is based on the Harvard IPA communication model (Prof.Bales) and may be employed for bilateral as well as multilateral talks.</span>
            </div>
        );
    }
}
